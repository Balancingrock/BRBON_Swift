...
public extension Item {
    ...
    public static func uint16(_ val: UInt16, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: UInt16, name: String? = nil, fixedByteCount: UInt32?) {
