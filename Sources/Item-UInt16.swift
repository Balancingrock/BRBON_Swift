...
public extension Item {
    ...
    /// Create a new UInt16 Item
    
    public static func uint16(_ val: UInt16) -> Item {
    ...
    public static func uint16(_ val: UInt16, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init(_ val: UInt16) {
    ...
    public convenience init?(_ val: UInt16, name: String) {
    ...
    public convenience init?(_ val: UInt16, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a uint16 type
    
    public var isUInt16: Bool { return type == .uint16 }
    
    
    /// Returns the UInt16 value of this Item if the item is a UInt16 and the isNil option is not set.
    ...
    public var uint16: UInt16? {
        ...
        get {
            guard type == .uint16 else { return nil }
            if header.options.isNil { return nil }
            return (_value.any as! UInt16)
        }
    }
}
