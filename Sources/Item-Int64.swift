...
public extension Item {
    ...
    public static func int64(_ val: Int64, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: Int64, name: String? = nil, fixedByteCount: UInt32?) {
