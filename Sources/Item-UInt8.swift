...
public extension Item {
    ...
    /// Create a new UInt8 Item
    
    public static func uint8(_ val: UInt8) -> Item {
    ...
    public static func uint8(_ val: UInt8, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: UInt8, name: String) {
    ...
    public convenience init?(_ val: UInt8, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a uint8 type
    
    public var isUInt8: Bool { return type == .uint8 }
    
    
    /// Returns the UInt8 value of this Item if the item is a UInt8 and the isNil option is not set.
    ...
    public var uint8: UInt8? {
        ...
        get {
            guard type == .uint8 else { return nil }
            if header.options.isNil { return nil }
            return (_value.any as! UInt8)
        }
    }
}
