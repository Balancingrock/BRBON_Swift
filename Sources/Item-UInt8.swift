...
public extension Item {
    ...
    public static func uint8(_ val: UInt8, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: UInt8, name: String? = nil, fixedByteCount: UInt32?) {
