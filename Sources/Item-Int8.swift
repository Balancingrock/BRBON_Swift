...
public extension Item {
    ...
    public static func int8(_ val: Int8, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: Int8, name: String? = nil, fixedByteCount: UInt32?) {
