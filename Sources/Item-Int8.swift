...
public extension Item {
    ...
    /// Create a new Int8 Item
    
    public static func int8(_ val: Int8) -> Item {
    ...
    public static func int8(_ val: Int8, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init(_ val: Int8) {
    ...
    public convenience init?(_ val: Int8, name: String) {
    ...
    public convenience init?(_ val: Int8, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a int8 type
    
    public var isInt8: Bool { return type == .int8 }
    
    
   /// Returns the Int8 value of this Item if the item is a Int8 and the isNil option is not set.
    ...
    public var int8: Int8? {
        ...
        get {
            guard type == .int8 else { return nil }
            if header.options.isNil { return nil }
            return (_value.any as! Int8)
        }
    }
}
