...
public extension Item {
    ...
    /// Returns true if the Item is a uint64 type
    
    public var isUInt64: Bool { return type == .uint64 }
    
    
    /// Returns the UInt64 value of this Item if the item is a UInt64 and the isNil option is not set.
