...
public extension Item {
    ...
    /// Create a new Float32 Item
    
    public static func float32(_ val: Float32) -> Item {
    ...
    public static func float32(_ val: Float32, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init(_ val: Float32) {
    ...
    public convenience init?(_ val: Float32, name: String) {
    ...
    public convenience init?(_ val: Float32, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a float32 type
    
    public var isFloat32: Bool { return type == .float32 }
    
    
    /// Returns the Float32 value of this Item if the item is a float32 and the isNil option is not set.
