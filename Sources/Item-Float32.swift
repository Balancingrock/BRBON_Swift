...
public extension Item {
    ...
    public static func float32(_ val: Float32, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: Float32, name: String? = nil, fixedByteCount: UInt32?) {
