...
public class DictionaryManager: _Item {
    ...
    ///
    /// - Parameters:
    ///   - name: The name for the dictionary.
    ///   - nameFieldLength: The length of the name field.
    ///   - fixedItemLength: The length of the dictionary item. If this value is specified then this will be the size of the dictionary. No changes allowed.
