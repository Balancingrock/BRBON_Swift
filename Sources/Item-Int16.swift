...
public extension Item {
    ...
    /// Create a new Int16 Item
    
    public static func int16(_ val: Int16) -> Item {
    ...
    public static func int16(_ val: Int16, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init(_ val: Int16) {
    ...
    public convenience init?(_ val: Int16, name: String) {
    ...
    public convenience init?(_ val: Int16, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a int16 type
    
    public var isInt16: Bool { return type == .int16 }
    
    
    /// Returns the Int16 value of this Item if the item is a Int16 and the isNil option is not set.
    ...
    public var int16: Int16? {
        ...
        get {
            guard type == .int16 else { return nil }
            if header.options.isNil { return nil }
            return (_value.any as! Int16)
        }
    }
}
