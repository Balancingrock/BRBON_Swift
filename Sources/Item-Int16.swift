...
public extension Item {
    ...
    public static func int16(_ val: Int16, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: Int16, name: String? = nil, fixedByteCount: UInt32?) {
