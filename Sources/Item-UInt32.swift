...
public extension Item {
    ...
    public static func uint32(_ val: UInt32, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: UInt32, name: String? = nil, fixedItemByteCount: UInt32?) {
