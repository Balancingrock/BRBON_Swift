...
public class Item: ItemAccess {
    ...
    internal init(basePtr: UnsafeMutableRawPointer, parentPtr: UnsafeMutableRawPointer?, manager: BufferManagerProtocol? = nil, endianness: Endianness) {
    ...
    internal static let nullItem: NullItem = {
        ...
        Null().storeAsItem(
            ...
            machineEndianness)
        return NullItem(basePtr: nullItemBuffer.baseAddress!, parentPtr: nil, endianness: machineEndianness)
    }()
...
internal extension Item {
    ...
    internal var usedValueByteCount: Int {
        ...
        case .array: return 8 + countValue * Int(UInt32(valuePtr: valuePtr.advanced(by: 4), endianness))
