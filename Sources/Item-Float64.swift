...
public extension Item {
    ...
    /// Create a new Float64 Item
    
    public static func float64(_ val: Float64) -> Item {
    ...
    public static func float64(_ val: Float64, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init(_ val: Float64) {
    ...
    public convenience init?(_ val: Float64, name: String) {
    ...
    public convenience init?(_ val: Float64, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a float64 type
    
    public var isFloat64: Bool { return type == .float64 }
    
    
    /// Returns the Float64 value of this Item if the item is a float64 and the isNil option is not set.
    ...
    public var float64: Float64? {
        ...
        get {
            guard type == .float64 else { return nil }
            if header.options.isNil { return nil }
            return (_value.any as! Float64)
        }
    }
}
