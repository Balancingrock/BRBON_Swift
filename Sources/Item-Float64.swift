...
public extension Item {
    ...
    public static func float64(_ val: Float64, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: Float64, name: String? = nil, fixedByteCount: UInt32?) {
