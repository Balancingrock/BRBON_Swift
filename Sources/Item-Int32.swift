...
public extension Item {
    ...
    public static func int32(_ val: Int32, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: Int32, name: String? = nil, fixedByteCount: UInt32?) {
