...
public extension Item {
    ...
    /// Create a new Int32 Item
    
    public static func int32(_ val: Int32) -> Item {
    ...
    public static func int32(_ val: Int32, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init(_ val: Int32) {
    ...
    public convenience init?(_ val: Int32, name: String) {
    ...
    public convenience init?(_ val: Int32, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a int32 type
    
    public var isInt32: Bool { return type == .int32 }
    
    
    /// Returns the Int32 value of this Item if the item is a Int32 and the isNil option is not set.
