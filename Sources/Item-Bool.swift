...
public extension Item {
    ...
    public static func bool(_ val: Bool, name: String? = nil, fixedByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init?(_ val: Bool, name: String? = nil, fixedByteCount: UInt32?) {
