...
public extension Item {
    ...
    /// Create a new boolean Item
    
    public static func bool(_ val: Bool) -> Item {
    ...
    public static func bool(_ val: Bool, name: String? = nil, fixedItemByteCount: UInt32? = nil) -> Item? {
    ...
    public convenience init(_ val: Bool) {
    ...
    public convenience init?(_ val: Bool, name: String) {
    ...
    public convenience init?(_ val: Bool, name: String? = nil, fixedItemByteCount: UInt32?) {
    ...
    /// Returns true if the Item is a bool type
    
    public var isBool: Bool { return type == .bool }
    
    
    /// Returns the boolean value of this Item if the item is a boolean and the isNil option is not set.
