...
class Array_Tests: XCTestCase {
    ...
    func testDefaultBinaryArray() {
        ...
        let brArr: Array<Data> = [Data([0x11, 0x12, 0x13]), Data([0x21, 0x22]), Data([0x31, 0x32, 0x33, 0x34])]
        ...
        XCTAssertEqual(am.root[0], Data([0x11, 0x12, 0x13]))
        XCTAssertEqual(am.root[1], Data([0x21, 0x22]))
        XCTAssertEqual(am.root[2], Data([0x31, 0x32, 0x33, 0x34]))
        ...
        XCTAssertEqual(am.root._arrayElementByteCount, 16)
        XCTAssertEqual(am.root.count, 4)
        XCTAssertEqual(am.root[3], Data([0x41, 0x42, 0x43, 0x44, 0x45, 0x46]))
    ...
    func testColorArray() {
        ...
        exp = Data([
            ...
            0xFB, 0x00, 0x06, 0xFF, 0x00, 0x00, 0x00, 0x00
            ])
    ...
    func testCrcBinaryArray() {
        ...
        XCTAssertEqual(am.root._arrayElementByteCount, 16)
        XCTAssertEqual(am.root.count, 1)
        XCTAssertEqual(am.root[0], BRCrcBinary(Data([0x11, 0x11, 0x11])))
        XCTAssertEqual(am.root[0], Data([0x11, 0x11, 0x11]))
