...
class Sequence_Tests: XCTestCase {
    ...
    func test() {
        ...
        let dm = ItemManager.createSequenceManager(endianness: Endianness.little)
        
        
        // Properties
        
        XCTAssertEqual(dm.root.itemType, ItemType.sequence)
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x30, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x78, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x90, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xB0, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xC8, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xe8, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x08, 0x01, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x30, 0x01, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x50, 0x01, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x78, 0x01, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xa8, 0x01, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xe0, 0x01, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x08, 0x02, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x38, 0x02, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x68, 0x02, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xa0, 0x02, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x12, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xc8, 0x02, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0xe0, 0x02, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
        ...
        exp = Data(bytes: [
            0x13, 0x00, 0x00, 0x00,  0x10, 0x03, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00,
