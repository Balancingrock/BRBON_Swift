...
class Int64_Tests: XCTestCase {
    ...
    func testDecoder() {
        ...
        let i = Int64(fromPtr: buffer.baseAddress!, Endianness.little)
        
        XCTAssertEqual(i, Int64(0x1122334455667788))
    }
    ...
    func testPortal() {
        ...
        XCTAssertEqual(im.root.valueType, ItemType.int64)
        ...
        im.root.int64 = Int64(0x1111222233334444)
        XCTAssertEqual(im.root.int64, Int64(0x1111222233334444))
