...
class Int8_BrbonCoder_Tests: XCTestCase {
    ...
    func test_NoNameField() {
        ...
        XCTAssertEqual(Int8(valuePtr: buffer.baseAddress!, machineEndianness), 7)
        
        buffer.copyBytes(from: exp)
        
        XCTAssertEqual(Int8(itemPtr: buffer.baseAddress!, machineEndianness), 5)
        
        buffer.copyBytes(from: [1])
        
        XCTAssertEqual(Int8(elementPtr: buffer.baseAddress!, machineEndianness), 1)
